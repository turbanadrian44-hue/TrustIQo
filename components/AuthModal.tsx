  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const mockUser: User = {
        ...
        name: isRegister ? name : (email.split('@')[0] || 'Felhasználó'),
        email: email,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white animate-fade-in-up">
        ...
        <div className="space-y-3 mb-6">
          <button className="w-full flex items-center justify-center space-x-2 bg-white border border-gray-200 p-3 rounded-xl hover:bg-gray-50 transition-colors font-medium text-gray-700">
          ...
          <button className="w-full flex items-center justify-center space-x-2 bg-[#1877F2] text-white p-3 rounded-xl hover:bg-[#166fe5] transition-colors font-medium">
